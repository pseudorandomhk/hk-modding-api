...
public class EnemyDeathEffects
{
    ...
    public void _orig_RecieveDeathEvent(float? attackDirection, bool resetDeathEvent = false, bool spellBurn = false, bool isWatery = false)
    {
        if (didFire) return;
    ...
    private void _orig_RecordKillForJournal() { }
