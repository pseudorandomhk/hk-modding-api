...
namespace System.Runtime.CompilerServices
{
    ...
    public sealed class TupleElementNamesAttribute : Attribute
    {
        ...
        /// construction, which <see cref="ValueType"/> occurrences are meant to 
        /// carry element names.
        /// </param>
        /// <remarks>
        /// This constructor is meant to be used on types that are built on an underlying
        /// occurrence of <see cref="ValueType"/> that is meant to carry element names.
        /// For instance, if <c>C</c> is a generic type with two type parameters, then a
        /// use of the constructed type <c>C{<see cref="ValueTuple{T1, T2}"/>, <see cref="ValueTuple{T1, T2, T3}"/></c>
        ...
        /// <summary>
        /// Specifies, in a prefix traversal of a type's
        /// construction, which <see cref="ValueTuple"/> occurrences are meant to
        /// carry element names.
        /// </summary>
